...
public class CodeGenator {
    ...
    public void genCode() {
//        String prefix = "";
        String moduleName = "teachermanager";
        // 1、创建代码生成器
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/" +moduleName + "?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
...
//        strategy.setTablePrefix( "edu"+ "_");//设置表前缀不生成
        ...
        //设置BaseEntity
        strategy.setSuperEntityClass("com.bai.teachermanager.utils.BaseEntity");
        // 填写BaseEntity中的公共字段
