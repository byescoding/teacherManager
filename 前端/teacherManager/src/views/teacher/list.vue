<template>
  <div class="app-container">
    ...
    <el-table :data="list" border stripe @selection-change="handleSelectionChange" >
      ...
      <el-table-column prop="name" label="教师名称" width="90" align="center"/>
      <el-table-column label="教师等级" prop="grade" width="100" align="center"/>
      </el-table-column>
      ...
            <el-table-column prop="university" label="毕业院校" width="150"/>
